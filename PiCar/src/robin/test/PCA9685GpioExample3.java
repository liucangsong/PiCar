 ...
 */
public class PCA9685GpioExample3 {
    ...
    public static void main(String args[]) throws Exception {
        ...
        final PCA9685GpioProvider gpioProvider = new PCA9685GpioProvider(bus, 0x6F, frequency, frequencyCorrectionFactor);
        // Define outputs in use for this example
        GpioPinPwmOutput[] myOutputs = provisionPwmOutputs(gpioProvider);
        //GpioPinDigitalOutput out = gpio.provisionDigitalOutputPin(gpioProvider, PCA9685Pin.PWM_01);
        // Reset outputs
        gpioProvider.reset();
        //
...
//        }
        // Set full ON
        //gpioProvider.setAlwaysOn(PCA9685Pin.PWM_01);
        ...
        myOutputs[1].setPwm(4095);
        
        Scanner in = new Scanner(System.in);
        int loc = SERVO_DURATION_NEUTRAL;
        int max = 1645;
        int min = 1251;
        while(true){
        for(loc=min; loc<=max; loc++){
        	System.out.println(loc);
        	//gpioProvider.setPwm(PCA9685Pin.PWM_07, loc);
        	myOutputs[7].setPwm(loc);
        	//System.out.print("input:");
	        //int step = in.nextInt();
	       // loc += step;
        	// Set 0.9ms pulse (R/C Servo minimum position) 
	        //gpioProvider.setPwm(PCA9685Pin.PWM_07, SERVO_DURATION_MIN);
	        ...
	        //Thread.sleep(3000);
	       // gpioProvider.setPwm(PCA9685Pin.PWM_07, SERVO_DURATION_MAX);
	        //
	        //Thread.sleep(3000);
        }
        }
